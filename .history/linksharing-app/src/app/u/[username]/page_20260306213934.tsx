...
export default async function PublicProfilePage({
  ...
  return (
    <main className="min-h-screen bg-[#FAFAFA]">
      <div className="h-[357px] rounded-b-[32px] bg-[#633CFF]" />
              ...
              links.map((link) => {
                ...
                return (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className={`flex min-h-[56px] items-center justify-between rounded-lg px-4 text-[16px] font-semibold text-white transition hover:opacity-90 ${
                      platform?.color || "bg-[#333333]"
                    }`}
                  >
